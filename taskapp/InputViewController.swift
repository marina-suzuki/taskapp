...
//  taskapp
//
//  Created by Marina Suzuki on 2016/07/22.
...
class InputViewController: UIViewController {
    ...
    @IBOutlet weak var tittleTextFiled: UITextField!
    ...
    override func viewDidLoad() {
        ...
        tittleTextFiled.text = task.title
    ...
    override func viewWillDisappear(animated: Bool) {
        try! realm.write {
            self.task.title = self.tittleTextFiled.text!
